...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    "inline-flex shrink-0 items-center justify-center gap-2 h-fit px-5 py-2.5 rounded-lg text-sm font-medium transition-all duration-300";

  const variants = {
    primary: "bg-primary text-white shadow-xl hover:brightness-110 ",
    secondary:
      "bg-white dark:bg-gray-900 text-primary shadow-lg dark:hover:shadow-lg dark:hover:shadow-gray-700 dark:shadow-gray-700 hover:brightness-110 hover:shadow-xl",
  };
