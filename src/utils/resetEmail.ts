export default function getResetEmail(otp: string) {
...
<p style="text-align: left;"><font face="arial, helvetica neue, helvetica, sans-serif"><span style="font-size:14px">You've requested to reset the password for your Blue Team account. To proceed, please use the following One-Time Password (OTP) to set a new password:</span></font></p>
...
<br>
<br>
If you did not request a password reset, please ignore this email or contact us immediately at contact@steerlucid.com to ensure your account's security.
<br>
<br>
For any further assistance, our support team is ready to help you.
<br>
<br>
Thank you for using Blue Team, where innovation meets practicality.
<br>
<br>
Best Regards,<br>
